...
export default function WhatsAppFAB({ 
  phoneNumber = "27716856449", 
  message = "Hi TruScan, I'm interested in workflow automation." 
}: WhatsAppProps) {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100]">
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-[#128C7E] transition-colors relative group"
      >
        <WhatsAppIcon />
